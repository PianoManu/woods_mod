...
public class MossyBirchTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
    private static final BlockState LOG = BlockList.mossy_birch_log.getDefaultState();
    private static final BlockState LEAF = Blocks.BIRCH_LEAVES.getDefaultState();
    private final boolean useExtraRandomHeight;

    public MossyBirchTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configIn, boolean doBlockNotifyIn, boolean extraRandomHeightIn) {
