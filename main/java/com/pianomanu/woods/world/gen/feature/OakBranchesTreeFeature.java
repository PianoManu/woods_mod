...
import com.pianomanu.woods.block.WoodsBaseBranchBlock;
...
public class OakBranchesTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {

    private static final BlockState MOSSY_OAK_LOG = Blocks.OAK_LOG.getDefaultState();
    private static final BlockState OAK_LEAVES = Blocks.OAK_LEAVES.getDefaultState();
    private static final BlockState BRANCHES = BlockList.oak_flexible_branch.getDefaultState();

    public OakBranchesTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn, boolean doBlockNotifyIn) {
    ...
    private int makeLimb(Set<BlockPos> p_208523_1_, IWorldGenerationReader worldIn, BlockPos p_208523_3_, BlockPos p_208523_4_, boolean p_208523_5_, MutableBoundingBox p_208523_6_) {
        if (!p_208523_5_ && Objects.equals(p_208523_3_, p_208523_4_)) {
            ...
            for(int j = 0; j <= i; ++j) {
                ...
                if (p_208523_5_) {
                    this.setBlockState(worldIn, blockpos1, BRANCHES);
                    //this.setLogState(p_208523_1_, worldIn, blockpos1, MOSSY_OAK_LOG.with(LogBlock.AXIS, this.getLoxAxis(p_208523_3_, blockpos1)), p_208523_6_);
    ...
    private void makeFoliage(IWorldGenerationReader worldIn, int p_208525_2_, BlockPos pos, List<MossyOakBigTreeFeature.FoliageCoordinates> p_208525_4_, MutableBoundingBox p_208525_5_, Set<BlockPos> changedBlocks) {
        for(MossyOakBigTreeFeature.FoliageCoordinates bigtreefeature$foliagecoordinates : p_208525_4_) {
    ...
    private void makeBranches(Set<BlockPos> p_208524_1_, IWorldGenerationReader p_208524_2_, int p_208524_3_, BlockPos p_208524_4_, List<MossyOakBigTreeFeature.FoliageCoordinates> p_208524_5_, MutableBoundingBox p_208524_6_) {
        for(MossyOakBigTreeFeature.FoliageCoordinates bigtreefeature$foliagecoordinates : p_208524_5_) {
    ...
    public boolean place(Set<BlockPos> changedBlocks, IWorldGenerationReader worldIn, Random rand, BlockPos position, MutableBoundingBox p_208519_5_) {
        ...
        if (i == -1) {
            ...
            int i1 = i - 5;
            List<MossyOakBigTreeFeature.FoliageCoordinates> list = Lists.newArrayList();
            list.add(new MossyOakBigTreeFeature.FoliageCoordinates(position.up(i1), l));
                    ...
                    for(int j1 = 0; j1 < k; ++j1) {
                        ...
                        if (this.makeLimb(changedBlocks, worldIn, blockpos, blockpos1, false, p_208519_5_) == -1) {
                            ...
                            if (this.makeLimb(changedBlocks, worldIn, blockpos2, blockpos, false, p_208519_5_) == -1) {
                                list.add(new MossyOakBigTreeFeature.FoliageCoordinates(blockpos, blockpos2.getY()));
                            }
                        }
                    }
                }
