...
public class MossyDarkOakTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
    private static final BlockState LOG = BlockList.mossy_dark_oak_log.getDefaultState();
    private static final BlockState LEAVES = Blocks.DARK_OAK_LEAVES.getDefaultState();

    public MossyDarkOakTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i49895_1_, boolean p_i49895_2_) {
