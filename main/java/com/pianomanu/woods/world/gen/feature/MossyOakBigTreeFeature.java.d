...
public class MossyOakBigTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {

    private static final BlockState MOSSY_OAK_LOG = BlockList.mossy_oak_log.getDefaultState(); //only logs are mossy logs, leaves are vanilla ones
    private static final BlockState OAK_LEAVES = Blocks.OAK_LEAVES.getDefaultState();

    public MossyOakBigTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn, boolean doBlockNotifyIn) {
