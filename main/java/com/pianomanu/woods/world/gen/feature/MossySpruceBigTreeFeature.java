...
public class MossySpruceBigTreeFeature extends HugeTreesFeature<NoFeatureConfig> {
    private static final BlockState TRUNK = BlockList.mossy_spruce_log.getDefaultState(); //only logs changed to mossy logs
    ...
    public MossySpruceBigTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn, boolean doBlockNotifyOnPlace, boolean useBaseHeightIn) {
