...
public class MossyAcaciaTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
    private static final BlockState TRUNK = BlockList.mossy_acacia_log.getDefaultState(); //only logs are changed, leaves stay same
    private static final BlockState LEAF = Blocks.ACACIA_LEAVES.getDefaultState();

    public MossyAcaciaTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51443_1_, boolean p_i51443_2_) {
