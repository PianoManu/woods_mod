...
public class SlabsInWorldGen extends Feature<NoFeatureConfig> {
    ...
    public boolean place(IWorld worldIn, ChunkGenerator<? extends GenerationSettings> generator, Random rand, BlockPos pos, NoFeatureConfig config) {
        ...
        BlockPos.Mutable blockpos$mutableblockposWest = new BlockPos.Mutable();
        BlockPos.Mutable blockpos$mutableblockposNorth = new BlockPos.Mutable();
        BlockPos.Mutable blockpos$mutableblockposEast = new BlockPos.Mutable();
        BlockPos.Mutable blockpos$mutableblockposSouth = new BlockPos.Mutable();
        BlockPos.Mutable blockpos$mutableblockposWestDown = new BlockPos.Mutable();
        BlockPos.Mutable blockpos$mutableblockposNorthDown = new BlockPos.Mutable();
        BlockPos.Mutable blockpos$mutableblockposEastDown = new BlockPos.Mutable();
        BlockPos.Mutable blockpos$mutableblockposSouthDown = new BlockPos.Mutable();
        BlockPos.Mutable blockpos$mutableblockposUp = new BlockPos.Mutable();
