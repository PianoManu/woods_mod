...
*/
        /*ShapedRecipeBuilder.shapedRecipe(ItemList.birch_branch, 4).key('#',Items.BIRCH_LOG).key('+', ItemList.moss_item).patternLine(" + ").patternLine("+#+").patternLine(" + ").addCriterion("has_moss", this.hasItem(ItemList.moss_item)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.birch_all_branch, 5).key('#', ItemList.birch_branch).patternLine(" # ").patternLine("###").patternLine(" # ").addCriterion("has_branches", this.hasItem(ItemList.birch_branch)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.birch_pillar_branch, 3).key('#', ItemList.birch_branch).patternLine("#").patternLine("#").patternLine("#").addCriterion("has_branches", this.hasItem(ItemList.birch_branch)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.birch_cross_branch, 4).key('#', ItemList.birch_branch).patternLine(" # ").patternLine("# #").patternLine(" # ").addCriterion("has_branches", this.hasItem(ItemList.birch_branch)).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(ItemList.birch_flexible_branch, 1).addIngredient(ItemList.birch_branch).addCriterion("has_branches", this.hasItem(ItemList.birch_branch)).build(consumer);*/
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.birch_branch, 1).addIngredient(ItemList.birch_all_branch).addCriterion("has_branches", this.hasItem(ItemList.birch_branch)).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(ItemList.birch_branch, 1).addIngredient(ItemList.birch_cross_branch).addCriterion("has_branches", this.hasItem(ItemList.birch_branch)).build(consumer);
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.birch_branch, 1).addIngredient(ItemList.birch_pillar_branch).addCriterion("has_branches", this.hasItem(ItemList.birch_branch)).build(consumer);
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.birch_branch, 1).addIngredient(ItemList.birch_flexible_branch).addCriterion("has_branches", this.hasItem(ItemList.birch_branch)).build(consumer);
        /*ShapedRecipeBuilder.shapedRecipe(ItemList.spruce_branch, 4).key('#',Items.SPRUCE_LOG).key('+', ItemList.moss_item).patternLine(" + ").patternLine("+#+").patternLine(" + ").addCriterion("has_moss", this.hasItem(ItemList.moss_item)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.spruce_all_branch, 5).key('#', ItemList.spruce_branch).patternLine(" # ").patternLine("###").patternLine(" # ").addCriterion("has_branches", this.hasItem(ItemList.spruce_branch)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.spruce_pillar_branch, 3).key('#', ItemList.spruce_branch).patternLine("#").patternLine("#").patternLine("#").addCriterion("has_branches", this.hasItem(ItemList.spruce_branch)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.spruce_cross_branch, 4).key('#', ItemList.spruce_branch).patternLine(" # ").patternLine("# #").patternLine(" # ").addCriterion("has_branches", this.hasItem(ItemList.spruce_branch)).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(ItemList.spruce_flexible_branch, 1).addIngredient(ItemList.spruce_branch).addCriterion("has_branches", this.hasItem(ItemList.spruce_branch)).build(consumer);*/
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.spruce_branch, 1).addIngredient(ItemList.spruce_all_branch).addCriterion("has_branches", this.hasItem(ItemList.spruce_branch)).build(consumer);
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.spruce_branch, 1).addIngredient(ItemList.spruce_cross_branch).addCriterion("has_branches", this.hasItem(ItemList.spruce_branch)).build(consumer);
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.spruce_branch, 1).addIngredient(ItemList.spruce_pillar_branch).addCriterion("has_branches", this.hasItem(ItemList.spruce_branch)).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(ItemList.spruce_branch, 1).addIngredient(ItemList.spruce_flexible_branch).addCriterion("has_branches", this.hasItem(ItemList.spruce_branch)).build(consumer);
        /*ShapedRecipeBuilder.shapedRecipe(ItemList.jungle_branch, 4).key('#',Items.JUNGLE_LOG).key('+', ItemList.moss_item).patternLine(" + ").patternLine("+#+").patternLine(" + ").addCriterion("has_moss", this.hasItem(ItemList.moss_item)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.jungle_all_branch, 5).key('#', ItemList.jungle_branch).patternLine(" # ").patternLine("###").patternLine(" # ").addCriterion("has_branches", this.hasItem(ItemList.jungle_branch)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.jungle_pillar_branch, 3).key('#', ItemList.jungle_branch).patternLine("#").patternLine("#").patternLine("#").addCriterion("has_branches", this.hasItem(ItemList.jungle_branch)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.jungle_cross_branch, 4).key('#', ItemList.jungle_branch).patternLine(" # ").patternLine("# #").patternLine(" # ").addCriterion("has_branches", this.hasItem(ItemList.jungle_branch)).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(ItemList.jungle_flexible_branch, 1).addIngredient(ItemList.jungle_branch).addCriterion("has_branches", this.hasItem(ItemList.jungle_branch)).build(consumer);*/
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.jungle_branch, 1).addIngredient(ItemList.jungle_all_branch).addCriterion("has_branches", this.hasItem(ItemList.jungle_branch)).build(consumer);
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.jungle_branch, 1).addIngredient(ItemList.jungle_cross_branch).addCriterion("has_branches", this.hasItem(ItemList.jungle_branch)).build(consumer);
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.jungle_branch, 1).addIngredient(ItemList.jungle_pillar_branch).addCriterion("has_branches", this.hasItem(ItemList.jungle_branch)).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(ItemList.jungle_branch, 1).addIngredient(ItemList.jungle_flexible_branch).addCriterion("has_branches", this.hasItem(ItemList.jungle_branch)).build(consumer);
        /*ShapedRecipeBuilder.shapedRecipe(ItemList.dark_oak_branch, 4).key('#',Items.DARK_OAK_LOG).key('+', ItemList.moss_item).patternLine(" + ").patternLine("+#+").patternLine(" + ").addCriterion("has_moss", this.hasItem(ItemList.moss_item)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.dark_oak_all_branch, 5).key('#', ItemList.dark_oak_branch).patternLine(" # ").patternLine("###").patternLine(" # ").addCriterion("has_branches", this.hasItem(ItemList.dark_oak_branch)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.dark_oak_pillar_branch, 3).key('#', ItemList.dark_oak_branch).patternLine("#").patternLine("#").patternLine("#").addCriterion("has_branches", this.hasItem(ItemList.dark_oak_branch)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.dark_oak_cross_branch, 4).key('#', ItemList.dark_oak_branch).patternLine(" # ").patternLine("# #").patternLine(" # ").addCriterion("has_branches", this.hasItem(ItemList.dark_oak_branch)).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(ItemList.dark_oak_flexible_branch, 1).addIngredient(ItemList.dark_oak_branch).addCriterion("has_branches", this.hasItem(ItemList.dark_oak_branch)).build(consumer);*/
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.dark_oak_branch, 1).addIngredient(ItemList.dark_oak_all_branch).addCriterion("has_branches", this.hasItem(ItemList.dark_oak_branch)).build(consumer);
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.dark_oak_branch, 1).addIngredient(ItemList.dark_oak_cross_branch).addCriterion("has_branches", this.hasItem(ItemList.dark_oak_branch)).build(consumer);
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.dark_oak_branch, 1).addIngredient(ItemList.dark_oak_pillar_branch).addCriterion("has_branches", this.hasItem(ItemList.dark_oak_branch)).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(ItemList.dark_oak_branch, 1).addIngredient(ItemList.dark_oak_flexible_branch).addCriterion("has_branches", this.hasItem(ItemList.dark_oak_branch)).build(consumer);
        /*ShapedRecipeBuilder.shapedRecipe(ItemList.acacia_branch, 4).key('#',Items.ACACIA_LOG).key('+', ItemList.moss_item).patternLine(" + ").patternLine("+#+").patternLine(" + ").addCriterion("has_moss", this.hasItem(ItemList.moss_item)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.acacia_all_branch, 5).key('#', ItemList.acacia_branch).patternLine(" # ").patternLine("###").patternLine(" # ").addCriterion("has_branches", this.hasItem(ItemList.acacia_branch)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.acacia_pillar_branch, 3).key('#', ItemList.acacia_branch).patternLine("#").patternLine("#").patternLine("#").addCriterion("has_branches", this.hasItem(ItemList.acacia_branch)).build(consumer);
        ShapedRecipeBuilder.shapedRecipe(ItemList.acacia_cross_branch, 4).key('#', ItemList.acacia_branch).patternLine(" # ").patternLine("# #").patternLine(" # ").addCriterion("has_branches", this.hasItem(ItemList.acacia_branch)).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(ItemList.acacia_flexible_branch, 1).addIngredient(ItemList.acacia_branch).addCriterion("has_branches", this.hasItem(ItemList.acacia_branch)).build(consumer);*/
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.acacia_branch, 1).addIngredient(ItemList.acacia_all_branch).addCriterion("has_branches", this.hasItem(ItemList.acacia_branch)).build(consumer);
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.acacia_branch, 1).addIngredient(ItemList.acacia_cross_branch).addCriterion("has_branches", this.hasItem(ItemList.acacia_branch)).build(consumer);
        //ShapelessRecipeBuilder.shapelessRecipe(ItemList.acacia_branch, 1).addIngredient(ItemList.acacia_pillar_branch).addCriterion("has_branches", this.hasItem(ItemList.acacia_branch)).build(consumer);
        ShapelessRecipeBuilder.shapelessRecipe(ItemList.acacia_branch, 1).addIngredient(ItemList.acacia_flexible_branch).addCriterion("has_branches", this.hasItem(ItemList.acacia_branch)).build(consumer);
