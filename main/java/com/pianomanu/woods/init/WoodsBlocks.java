    ...
    public static class RegistryEvents {
        ...
        public static void registerBlocks(final RegistryEvent.Register<Block> event) {
            ...
            event.getRegistry().registerAll(
                    ...
                    BlockList.birch_branch = (WoodsBranchBlock) new WoodsBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("birch_branch")),
                    BlockList.birch_up_branch = (WoodsUpBranchBlock) new WoodsUpBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("birch_up_branch")),
                    BlockList.birch_wall_branch = (WoodsWallBranchBlock) new WoodsWallBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("birch_wall_branch")),
                    BlockList.birch_cross_branch = (WoodsCrossBranchBlock) new WoodsCrossBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("birch_cross_branch")),
                    BlockList.birch_pillar_branch = (WoodsPillarBranchBlock) new WoodsPillarBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("birch_pillar_branch")),
                    BlockList.birch_all_branch = (WoodsAllBranchBlock) new WoodsAllBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("birch_all_branch")),
                    BlockList.birch_flexible_branch = (WoodsBaseBranchBlock) new WoodsBaseBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName("birch_flexible_branch"),
                    BlockList.spruce_branch = (WoodsBranchBlock) new WoodsBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("spruce_branch")),
                    BlockList.spruce_up_branch = (WoodsUpBranchBlock) new WoodsUpBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("spruce_up_branch")),
                    BlockList.spruce_wall_branch = (WoodsWallBranchBlock) new WoodsWallBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("spruce_wall_branch")),
                    BlockList.spruce_cross_branch = (WoodsCrossBranchBlock) new WoodsCrossBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("spruce_cross_branch")),
                    BlockList.spruce_pillar_branch = (WoodsPillarBranchBlock) new WoodsPillarBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("spruce_pillar_branch")),
                    BlockList.spruce_all_branch = (WoodsAllBranchBlock) new WoodsAllBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("spruce_all_branch")),
                    BlockList.spruce_flexible_branch = (WoodsBaseBranchBlock) new WoodsBaseBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName("spruce_flexible_branch"),
                    BlockList.jungle_branch = (WoodsBranchBlock) new WoodsBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("jungle_branch")),
                    BlockList.jungle_up_branch = (WoodsUpBranchBlock) new WoodsUpBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("jungle_up_branch")),
                    BlockList.jungle_wall_branch = (WoodsWallBranchBlock) new WoodsWallBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("jungle_wall_branch")),
                    BlockList.jungle_cross_branch = (WoodsCrossBranchBlock) new WoodsCrossBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("jungle_cross_branch")),
                    BlockList.jungle_pillar_branch = (WoodsPillarBranchBlock) new WoodsPillarBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("jungle_pillar_branch")),
                    BlockList.jungle_all_branch = (WoodsAllBranchBlock) new WoodsAllBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("jungle_all_branch")),
                    BlockList.jungle_flexible_branch = (WoodsBaseBranchBlock) new WoodsBaseBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName("jungle_flexible_branch"),
                    BlockList.dark_oak_branch = (WoodsBranchBlock) new WoodsBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("dark_oak_branch")),
                    BlockList.dark_oak_up_branch = (WoodsUpBranchBlock) new WoodsUpBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("dark_oak_up_branch")),
                    BlockList.dark_oak_wall_branch = (WoodsWallBranchBlock) new WoodsWallBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("dark_oak_wall_branch")),
                    BlockList.dark_oak_cross_branch = (WoodsCrossBranchBlock) new WoodsCrossBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("dark_oak_cross_branch")),
                    BlockList.dark_oak_pillar_branch = (WoodsPillarBranchBlock) new WoodsPillarBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("dark_oak_pillar_branch")),
                    BlockList.dark_oak_all_branch = (WoodsAllBranchBlock) new WoodsAllBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("dark_oak_all_branch")),
                    BlockList.dark_oak_flexible_branch = (WoodsBaseBranchBlock) new WoodsBaseBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName("dark_oak_flexible_branch"),
                    BlockList.acacia_branch = (WoodsBranchBlock) new WoodsBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("acacia_branch")),
                    BlockList.acacia_up_branch = (WoodsUpBranchBlock) new WoodsUpBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("acacia_up_branch")),
                    BlockList.acacia_wall_branch = (WoodsWallBranchBlock) new WoodsWallBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("acacia_wall_branch")),
                    BlockList.acacia_cross_branch = (WoodsCrossBranchBlock) new WoodsCrossBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("acacia_cross_branch")),
                    BlockList.acacia_pillar_branch = (WoodsPillarBranchBlock) new WoodsPillarBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("acacia_pillar_branch")),
                    BlockList.acacia_all_branch = (WoodsAllBranchBlock) new WoodsAllBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName(location("acacia_all_branch")),
                    BlockList.acacia_flexible_branch = (WoodsBaseBranchBlock) new WoodsBaseBranchBlock(Block.Properties.create(Material.WOOD, MaterialColor.WOOD).hardnessAndResistance(2.0F).harvestLevel(1).harvestTool(ToolType.AXE).sound(SoundType.WOOD)).setRegistryName("acacia_flexible_branch"),
